...
const DummyPromoData: Array<PromoData> = [
    ...
    },
    {
        ...
        ShowHotPromo: true,
        CardLogo: 'https://poininngcdn.azureedge.net/smartpromo/Merchant/PromoLogo/7e08bbec-41e7-468e-b8eb-46a3a320d1ee.png',
        Day: '3 DAYS LEFT',
    },
    {
        id: '4',
    ...
    {
        id: '6',
        MerchantLogo: 'https://poininngcdn.azureedge.net/smartpromo/Merchant/PromoLogo/e0d1f32b-1257-451d-9c3f-e189393be8c0.png',
        Background: 'https://poininngcdn.azureedge.net/smartpromo/Promo/Background/c4d7904e-d95f-4c5e-86aa-06650826b599.jpg',
        TitleRow1: 'Diskon',
        TitleRow2: 'Hingga 65%',
        Color: 'rgb(240, 122, 15)',
        ShowHotPromo: true,
        CardLogo: '',
        Day: '3 DAYS LEFT',
    },
